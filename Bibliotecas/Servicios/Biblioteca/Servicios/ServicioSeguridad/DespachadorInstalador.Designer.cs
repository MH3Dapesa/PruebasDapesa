namespace Dapesa.Servicios.ASW.ServicioSeguridad
{
	partial class DespachadorInstalador
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this._oInstaladorServicio.Description = "Servicio para atención de solicitudes de acceso a datos, relativo a la capa de seguridad";
			this._oInstaladorServicio.DisplayName = "Dapesa.Seguridad";
			this._oInstaladorServicio.ServiceName = "Dap.Seguridad";
			// 
