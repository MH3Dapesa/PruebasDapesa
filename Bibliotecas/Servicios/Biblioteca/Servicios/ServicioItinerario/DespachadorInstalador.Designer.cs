namespace Dapesa.Servicios.ASW.ServicioItinerario
{
	partial class DespachadorInstalador
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this._oInstaladorServicio.Description = "Servicio para atención de solicitudes de acceso a datos, relativo al módulo de itinerario de telemarketing";
			this._oInstaladorServicio.DisplayName = "Dapesa.Itinerario";
			this._oInstaladorServicio.ServiceName = "Dap.Itinerario";
			// 
