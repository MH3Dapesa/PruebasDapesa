...
{
	internal class ClienteSqlServer : Cliente, ICliente
	{
		#region Atributos

		private SqlDataAdapter _oAdaptadorDatos;
		...
		internal ClienteSqlServer(Conexion poConexion)
			: base((poConexion.Tipo == Dapesa.Comun.Definiciones.TipoConexion.CredencialesExplicitas)
				? "Server=" + poConexion.Servidor + ";Database=" + poConexion.BaseDatos + ";User Id=" + poConexion.Credenciales.Usuario + ";Password=" + poConexion.Credenciales.Cifrado.Descifrar(poConexion.Credenciales.Contrasenia) + ";"
		...
		protected override bool Conectar()
		{
			...
			try
			{
				...
				{
					this._oConexion = new SqlConnection();
		...
		protected override void CrearComando(Sentencia poSentencia)
		{
			...
			try
			{
				...
				if (poSentencia.Parametros != null)
					...
					{
						SqlParameter loParametro = new SqlParameter();
		...
		protected override DataTable EjecutarQuery()
		{
			...
			try
			{
				...
				this._oAdaptadorDatos = new SqlDataAdapter();
