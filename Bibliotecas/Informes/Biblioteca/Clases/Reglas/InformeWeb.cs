...
{
	internal class InformeWeb : Informe, IInforme
	{
		#region Atributos
		...
		protected override void Imprimir()
		{
			...
			try
			{
                ...
                if (!string.IsNullOrEmpty(base._sImpresora))
                    ...
                    //loImpresora.PrinterSettings.PrinterName = "\\\\192.168.0.183\\Xerox Phaser 3420 PCL 6";
                    //loImpresora.PrinterSettings.PrinterName = "Xerox WC 4118 Series PCL 6";
                ...
                else
                {
                    ...
                    //loImpresora.DefaultPageSettings.Landscape = true;
                    loImpresora.Print();
                }
			}
