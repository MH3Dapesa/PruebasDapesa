<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InicioSesion.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.InicioSesion" %>
...
<head runat="server">
	...
	<title>Login::.Dapesa.Almacén.Pedidos.Trazabilidad.Documentación</title>
												...
												<table border="0" style="padding:0px;">
													...
													<tr>
														...
														<td style="text-align:left;">
															<asp:TextBox ID="UserName" runat="server" Width="200px" CssClass="upperText" />
														</td>
														<td>
													...
													<tr>
														<td style="white-space:nowrap;text-align:right;">
															<asp:Label ID="DataBaseLabel" runat="server" AssociatedControlID="DataBase" Text="Base de datos:&nbsp;" />
														</td>
														<td style="text-align:left;">
															<asp:TextBox ID="DataBase" runat="server" Width="200px" Text="SIIL" CssClass="upperText" />
														</td>
														<td>
															<asp:RequiredFieldValidator ID="DataBaseRequired" runat="server" ControlToValidate="DataBase" ErrorMessage="La base de datos es requerida" ToolTip="La base de datos es requerida" ValidationGroup="LoginValidationGroup" Text="*" ForeColor="Red" />
														</td>
													</tr>
													<tr>
														<td style="text-align:center;" colspan="3">
