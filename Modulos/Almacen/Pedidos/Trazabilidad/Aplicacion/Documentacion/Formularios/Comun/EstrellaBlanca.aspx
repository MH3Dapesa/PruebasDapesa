<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstrellaBlanca.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.EstrellaBlanca" MasterPageFile="~/Site.Master" %>
					...
					<table border="0">
						...
						<tr>
							...
							<td style="width:auto;text-align:right;">
								<asp:RadioButtonList ID="rblServicio" runat="server" TabIndex="10" RepeatDirection="Horizontal" Width="100%" OnSelectedIndexChanged="rblServicio_SelectedIndexChanged">
									<asp:ListItem Value="0" Text="Ocurre" />
									<asp:ListItem Value="1" Text="Domicilio" Selected="True" />
								</asp:RadioButtonList>
							</td>
						</tr>
						<tr>
							...
							<td style="width:auto;text-align:right;">
								<asp:CheckBox ID="cbRemitente" runat="server" Text="Imprimir remitente" OnCheckedChanged="cbRemitente_CheckedChanged" AutoPostBack="true" TabIndex="11" />
							</td>
						</tr>
					</table>
				</ContentTemplate>
