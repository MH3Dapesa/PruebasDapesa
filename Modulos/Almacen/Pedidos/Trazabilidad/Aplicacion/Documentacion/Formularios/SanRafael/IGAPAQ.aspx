<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IGAPAQ.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.IGAPAQ" %>
					...
					<table border="0">
						...
						<tr>
							<td style="text-align:right;vertical-align:middle;" colspan="3">
								<asp:CheckBox ID="cbOcurre" runat="server" Visible="true" Text="Ocurre" OnCheckedChanged="cbOcurre_CheckedChanged" AutoPostBack="true" />
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
                        ...
                        <tr>
							<td style="white-space:nowrap;">Contenido:</td>
							<td colspan="2">
								<asp:TextBox ID="txtContenido" runat="server" CssClass="upperText" TabIndex="10" />
							</td>
						</tr>
                        <tr>
							<td style="white-space:nowrap;">Total pieza:</td>
							<td colspan="2">
								<asp:TextBox ID="txtTotalPiezas" runat="server" CssClass="upperText" TabIndex="11" />
							</td>
						</tr>
						<%--<tr>
						...
						<tr>
							...
							<td style="width:auto;text-align:right;">
								<asp:CheckBox ID="cbRemitente" runat="server" Visible="false" Checked="true" Text="Imprimir remitente" TabIndex="13" />
							</td>
						</tr>
					</table>
				</ContentTemplate>
