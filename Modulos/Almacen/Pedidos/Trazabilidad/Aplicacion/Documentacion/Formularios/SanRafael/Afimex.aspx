<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Afimex.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.Afimex" MasterPageFile="~/Site.Master" %>
					...
					<table border="0">
						...
						<tr>
							...
							<td style="padding-left:20px;vertical-align:bottom;" rowspan="8">
								...
								<asp:ImageButton ID="btnImprimir" runat="server" AlternateText="Imprimir" ImageUrl="~/Img/impresora.png" BackColor="#F5F5F5" BorderColor="#CCCCCC" BorderStyle="Solid" BorderWidth="1px" Visible="false" TabIndex="10" OnClick="btnImprimir_Click" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<asp:TextBox ID="txtPoblacion" runat="server" Width="400px" CssClass="upperText" TabIndex="6" />
							</td>
						</tr>
						<tr>
							<td>Tel&eacute;fono:</td>
							<td>
								<asp:TextBox ID="txtTelefono" runat="server" Width="270px" CssClass="upperText" TabIndex="7" />
							</td>
						</tr>
						<tr>
							<td style="white-space:nowrap;">C&oacute;digo postal:</td>
							<td>
								<asp:TextBox ID="txtCodigoPostal" runat="server" CssClass="upperText" TabIndex="8" />
							</td>
						</tr>
                        ...
                        <tr>
							<td>Peso:</td>
							<td>
								<asp:TextBox ID="txtPeso" runat="server" Text="1" TabIndex="9" MaxLength="6" />
								<asp:RegularExpressionValidator ID="revPeso" runat="server" ControlToValidate="txtPeso" ValidationExpression="^(\d|-)?(\d|,)*\.?\d*$" Text="Solo se permiten números." />
							</td>
						</tr>
						<tr>
							<td>Copias:</td>
							<td>
								<asp:TextBox ID="txtCopias" runat="server" Text="1" TabIndex="9" MaxLength="2" />
