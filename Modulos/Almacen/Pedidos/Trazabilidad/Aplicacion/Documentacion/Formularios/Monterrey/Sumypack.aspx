<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sumypack.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.Formularios.Monterrey.Sumypack" %>
			...
			<asp:UpdatePanel ID="upPanelGuia" runat="server" UpdateMode="Conditional">
				<ContentTemplate>
					<table border="0">
						...
						<tr>
							<td>N&uacute;mero piezas:</td>
							<td colspan="2">
								<asp:TextBox ID="txtNumPiezas" runat="server" Text="1" TabIndex="10" MaxLength="2" />
								<asp:FilteredTextBoxExtender ID="ftxteNumPiezas" runat="server" TargetControlID="txtNumPiezas" FilterType="Numbers" />
							</td>
						</tr>
						<tr>
							<td>Peso:</td>
							<td colspan="2">
								<asp:TextBox ID="txtPeso" runat="server" Text="1" TabIndex="11" MaxLength="6" />
                        ...
                        <tr>
							<td></td>
							<td>
								<asp:RadioButton ID="rbSobre" runat="server" Text="Sobre." GroupName="gbrbTipo"  />
                                <asp:RadioButton ID="rbPaquete" runat="server" Text="Paquete." GroupName="gbrbTipo" />
                                <asp:RadioButton ID="rbCaja" runat="server" Text="Caja." Checked="true" GroupName="gbrbTipo" />
							</td>
						</tr>
					</table>
				</ContentTemplate>
