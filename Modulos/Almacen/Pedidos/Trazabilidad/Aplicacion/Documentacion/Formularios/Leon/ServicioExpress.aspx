<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServicioExpress.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.ServicioExpress" MasterPageFile="~/Site.Master" %>
				...
				<ContentTemplate>
					<table border="0">
						...
						<tr>
							<td>RFC:</td>
							<td>
								<asp:TextBox ID="txtRFC" runat="server" Width="400px" CssClass="upperText" TabIndex="4" />
							</td>
						</tr>
						<tr>
							<td>Domicilio:</td>
