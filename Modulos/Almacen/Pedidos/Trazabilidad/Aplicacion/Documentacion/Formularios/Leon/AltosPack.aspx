<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AltosPack.aspx.cs" Inherits="Dapesa.Almacen.Pedidos.Trazabilidad.IU.Documentacion.AltosPack" MasterPageFile="~/Site.Master" %>
					...
					<table border="0">
						...
						<tr>
							<td style="text-align:right;vertical-align:middle;" colspan="3">
								<asp:CheckBox ID="cbOcurre" runat="server" Visible="false" Text="Ocurre" OnCheckedChanged="cbOcurre_CheckedChanged" AutoPostBack="true" />
							</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
