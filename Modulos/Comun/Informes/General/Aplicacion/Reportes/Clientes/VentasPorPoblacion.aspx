<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VentasPorPoblacion.aspx.cs" Inherits="Dapesa.Comun.Informes.General.IU.Reportes.Clientes.VentasPorPoblacion" EnableEventValidation="false" %>
...
<asp:Content ID="cContenido" ContentPlaceHolderID="cphContenidoPrincipal" runat="server">
    <div>
        ...
        <asp:Panel ID="pnlParametros" runat="server" DefaultButton="btnGenerar">
                        ...
                        <table>
                            <tr>
                                <td style="white-space: nowrap;" colspan="2">
                                    ...
                                    <asp:CalendarExtender ID="ceFechaInicio" runat="server" PopupButtonID="btnFechaInicio" TargetControlID="txtFechaInicio" Format="MM/yyyy" PopupPosition="BottomLeft" DefaultView="Months" TodaysDateFormat="MM/yyyy" OnClientHidden="onCalendarHidden1"  OnClientShown="onCalendarShown1" BehaviorID="Calendario1" />
                                </td>
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    <asp:CalendarExtender ID="ceFechaFin" runat="server" PopupButtonID="btnFechaFin" TargetControlID="txtFechaFin" Format="MM/yyyy" PopupPosition="BottomLeft" DefaultView="Months" TodaysDateFormat="MM/yyyy" OnClientHidden="onCalendarHidden2"  OnClientShown="onCalendarShown2" BehaviorID="Calendario2"  />
                                </td>

                                <td style="padding-left: 10px; color: red; font-size: 8pt;" colspan="3">
                                    <label id="lblFechas" style="visibility:hidden">La fecha final, debe ser mayor o igual a la fecha de inicio.</label> 
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table>
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="btnGenerar" runat="server" OnClick="btnGenerar_Click" Text="Generar" OnClientClick="return ValidarFechas()"/>
                    </td>
                </tr>
            </table>
        ...
        <script>
            $("#<%= txtFechaInicio.ClientID %>").val((new Date()).localeFormat("MM/yyyy"));
            $("#<%= txtFechaFin.ClientID %>").val((new Date()).localeFormat("MM/yyyy"));

            function ValidarFechas() {
                FechaInicio = new Date('01/' + $("#<%= txtFechaInicio.ClientID %>").val());
                FechaFin = new Date('01/' + $("#<%= txtFechaFin.ClientID %>").val());
                ...
                if (FechaInicio <= FechaFin ) {
                    ...
                    document.getElementById("lblFechas").style.visibility = "visible";
                    return false;
                }
            }
        </script>
