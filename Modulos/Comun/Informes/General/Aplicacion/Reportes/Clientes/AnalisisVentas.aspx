<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AnalisisVentas.aspx.cs" Inherits="Dapesa.Comun.Informes.General.IU.Reportes.Clientes.AnalisisVentas" EnableEventValidation="false" %>
    ...
    <div>
        ...
        <asp:Panel ID="pnlParametros" runat="server" DefaultButton="btnGenerar">
            ...
            <table>
                <tr>
                    <td style="width:90px;">
                        <asp:Label ID="lblMostrarPor" runat="server" Text = "<u><b>A</b></u>grupar por:" />
                    </td>
                    <td>
                        <asp:RadioButton ID="rbAgruparGestor" runat="server" Checked="true" Text="Gestor" GroupName="MostrarPor" />
                    </td>
                    <td>
                        <asp:RadioButton ID="rbAgruparVendedor" runat="server" Checked="false" Text="Vendedor" GroupName="MostrarPor" />
                    </td>
                    <td>
                        <asp:RadioButton ID="rbAgruparCliente" runat="server" Checked="false" Text="Cliente" GroupName="MostrarPor" />
                    </td>
                </tr>
            </table>
            <table>
