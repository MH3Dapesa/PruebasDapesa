<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AntiguedadSaldos.aspx.cs" Inherits="Dapesa.Comun.Informes.Credito.IU.ReportesCredito.Clientes.AntiguedadSaldos" EnableEventValidation="false" %>
        ...
        <asp:Panel ID="pnlParametros" runat="server" DefaultButton="btnGenerar">
            <table style="border-spacing:0 3px; border-collapse:separate">
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="rfvGestores" runat="server" ControlToValidate="ddlGestores" ErrorMessage="*Debe seleccionar un gestor.<br />" ToolTip="Debe seleccionar un gestor.<br />" ForeColor="Red" Font-Size="8pt" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td style="float:right;">
                        <asp:CheckBox ID="cbDiasAdicionales" runat="server" Text="Dias adicionales" Checked="true" />
                    </td>
                    <td></td>
                </tr>
                <tr>
