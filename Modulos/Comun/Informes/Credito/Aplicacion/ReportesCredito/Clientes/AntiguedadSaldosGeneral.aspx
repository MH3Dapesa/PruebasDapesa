<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AntiguedadSaldosGeneral.aspx.cs" Inherits="Dapesa.Comun.Informes.Credito.IU.ReportesCredito.Clientes.AntiguedadSaldosGeneral" EnableEventValidation="false"%>
            ...
            <table style="border-spacing:0 3px; border-collapse:separate">
                ...
                <tr>
                    ...
                    <td style="float:right;">
                        ...
                        <asp:CheckBox ID="cbEnviarCorreo" runat="server" Text="Enviar Correo" Checked="false" />
                    </td>
                    <td></td>
                </tr>
                <tr>
