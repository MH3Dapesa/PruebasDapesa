<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Seller.aspx.cs" Inherits="Sistemas.Desbloqueos.IU.LockTable.Seller" %>
            ...
            <ContentTemplate>
                <asp:Panel runat="server" CssClass="panel-group" ScrollBars="Vertical">
                    <div style="height: 490px;">
                        <asp:GridView ID="gvVendedores" runat="server" CssClass="table table-condensed" GridLines="None" BorderStyle="None" Width="100%"
                            Style="font-size: 12px;" OnRowDataBound="gvVendedores_RowDataBound" EmptyDataText="No se encontraron vendedores conectados." ShowHeaderWhenEmpty="True">
